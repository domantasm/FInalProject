            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.nav_exercises:
                        Intent intent1 = new Intent(ExerciseListActivity.this, MuscleGroupActivity.class);
                        intent1.putExtra("email", email);
                        startActivity(intent1);
                        overridePendingTransition(0, 0);
                        return true;
                    case R.id.nav_home:
                        Intent intent2 = new Intent(ExerciseListActivity.this, HomeActivity.class);
...
//                        startActivity(new Intent(getApplicationContext(), FavouriteActivity.class));
                        Intent intent3 = new Intent(ExerciseListActivity.this, FavouriteActivity.class);
    ...
    public void getExercises() {
        ...
        String collectionPath = ("Equipment/" + formatEquipment + "/Muscle-Groups/" + formatMG + "/Exercises");
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ConstraintLayout layout = (ConstraintLayout)findViewById(R.id.mglayout);
                                ...
                                if(buttonCounter == 0) {
                                    ...
                                    button.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            ...
                                            Intent intent = new Intent(ExerciseListActivity.this, DisplayExerciseActivity.class);
                                            intent.putExtra("muscle-group", muscle_group);
                                            intent.putExtra("equipment", equipment);
                                            intent.putExtra("exercise", buttonText);
                                            intent.putExtra("email", email);
                                            System.out.println("++> mg, equip, exercise" + muscle_group + " " + equipment + " " + buttonText);
